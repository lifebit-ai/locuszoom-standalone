...
panel.barplot = function(dframe,xcol="pos",ycol="value",computeOptimalRows=F) {
  if (!computeOptimalRows) {
...
default.args <- list(
  ...
  barplotOffLineColor = "gray",         # color of dashed non-SNP-matched barplot peak lines
